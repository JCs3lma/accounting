@if ($paginator->hasPages())
    <nav class="w-full flex justify-between" role="navigation" aria-label="{{ __('Pagination Navigation') }}">

        <div class="w-full flex gap-2 items-center justify-between sm:hidden">
