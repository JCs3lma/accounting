                            ...
                            <td class="py-3 pr-5 whitespace-nowrap text-ellipsis {{$value['tdClass'] ?? ''}}">
                                ...
                                @else
                                    ...
                                    @elseif (isset($value['cast']))
                                        @php
                                            $tag = $value['cast'];
                                            $classCast = $value['tdContentClass'];
                                            if ($theadKey === 'status') {
                                                switch(data_get($fields, $theadKey)) {
                                                    case 'Draft':
                                                        $classCast .= '  bg-gray-100 text-gray-800';
                                                        break;
                                                    case 'Pending':
                                                        $classCast .= '  bg-yellow-100 text-yellow-800';
                                                        break;
                                                    case 'Approved':
                                                        $classCast .= '  bg-blue-100 text-blue-800';
                                                        break;
                                                    case 'Received':
                                                        $classCast .= '  bg-green-100 text-green-800';
                                                        break;
                                                    case 'Cancelled':
                                                        $classCast .= '  bg-red-100 text-red-800';
                                                        break;
                                                }
                                            }
                                        @endphp
